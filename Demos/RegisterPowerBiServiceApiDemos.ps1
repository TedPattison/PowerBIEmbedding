...
$appDisplayName = "Power BI Service API Demo"
...
$outputFile = "$PSScriptRoot\PowerBiServiceApiDemo.txt"
Out-File -FilePath $outputFile -InputObject "--- Power BI Service API Demo ---"
